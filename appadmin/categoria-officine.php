...
$dir_site = "https://app.katoimer.com/appadmin/";
...
<body class="hold-transition skin-blue sidebar-mini" >
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#">Officine/Dealers</a></li>
          ...
          <div class="row">
            ...
            ?>
              <div class="box-header with-border">
                <a href="./officina-profile.php?act=add&lingua=<?php echo $lingua; ?>" title="Aggiungi in lingua <?php echo $lingua; ?>" class="btn btn-primary margin-bottom">
                  <i class="fa fa-plus-circle" aria-hidden="true"></i> Aggiungi Officina/Dealer</a>
        ...
        /* AGGIUNGI */
          ...
          if (strcmp($act,"edit") == 0) { // edit fields
            ...
            $stmtup->prepare("SELECT O.ID_item, O.Nome, O.Email, O.Officina, O.Dealer, O.Stato
                              FROM officine O");

            $stmtup->execute();

            $stmtup->store_result();
            $stmtup->bind_result($ID_item, $Nome, $Email, $Officina, $Dealer, $Stato); 
        ...
        ?>
              ...
              <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs pull-right">
                  ...
                  ?>
                  <li class="pull-left header"><?php echo $label_tit; ?> Officina/Dealer</li>
                </ul>
                ...
                <div class="tab-content ">
                  ...
                  <form id="addForm" name="addForm" method="post" >
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="box-body pad ">
                          ...
                          <div class="form-group">
                            ...
                            sì 
                            <input type="radio" name="proprietario" value="1" <?php echo $flagSelOfficina1; ?>  />
                            <input type="radio" name="proprietario" value="0" <?php echo $flagSelOfficina0; ?> /> no
                          ...
                          <div class="form-group">
                            ...
                            <label>Dealer</label>
                            sì 
                            <input type="radio" name="ospite" value="1" <?php echo $flagSelDealer1; ?>  />
                            <input type="radio" name="ospite" value="0" <?php echo $flagSelDealer0; ?> /> no
                    ...
                    <div class="box-footer with-border">
                      <a href="categoria-users.php?act=load" class="btn btn-default"><i class="fa fa-chevron-circle-left" aria-hidden="true"></i> Torna alla lista Officine/Dealers</a>
                  ...
                  <form id="addMeta" name="addMeta" method="post" >
                    ...
                    <div class="box-footer with-border">
                      <a href="categoria-page.php?act=load" class="btn btn-default"><i class="fa fa-chevron-circle-left" aria-hidden="true"></i> Torna alla lista Officine/Dealers<</a>
      ...
      $(document).ready(function(e) {
        ...
        // visualizzazione iniziale officine
